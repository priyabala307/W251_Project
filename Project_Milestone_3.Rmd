...
-   Vaccination dataset 
    ...
    -   Create a vaccination rate metric and summarize to include only one row per strata of interest - DONE
...
```{r}
# Assuming 'merged_final_alameda' is your dataset

# Define the columns for which you want to compute the descriptive statistics
columns <- c(
